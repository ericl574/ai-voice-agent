...
// Step 1 of password reset: request the email. Supabase sends a recovery link that lands on
// /auth/confirm (token verification) and then redirects to /reset-password/update.
