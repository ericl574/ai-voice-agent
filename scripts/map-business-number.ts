...
// It does NOT buy Twilio numbers and does NOT deploy anything — those stay manual (docs/call-forwarding-setup.md).
//
...
async function main(): Promise<void> {
  ...
  console.log('\n── Remaining concierge activation steps (see docs/call-forwarding-setup.md) ──');
