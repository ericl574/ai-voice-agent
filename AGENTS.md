...
- Specialist voice-agent architecture (intent→specialist registry + post-call analyst; the in-prompt specialist *playbooks* were removed 2026-07-23 when the prompt was cut to a short role + guardrails) → `docs/agent-specialists.md`
